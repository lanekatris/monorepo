...
type PingRequest struct {
	...
	WhoAmI string `protobuf:"bytes,1,opt,name=whoAmI,proto3" json:"whoAmI,omitempty"`
}
...
func (x *PingRequest) GetWhoAmI() string {
	if x != nil {
		return x.WhoAmI
	}
	return ""
...
type PongResponse struct {
	...
	Idk string `protobuf:"bytes,1,opt,name=idk,proto3" json:"idk,omitempty"`
}
...
func (x *PongResponse) GetIdk() string {
	if x != nil {
		return x.Idk
	}
	return ""
...
var file_all_proto_rawDesc = []byte{
	0x0a, 0x09, 0x61, 0x6c, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x25, 0x0a, 0x0b, 0x50,
	0x69, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x77, 0x68,
	0x6f, 0x41, 0x6d, 0x49, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x77, 0x68, 0x6f, 0x41,
	0x6d, 0x49, 0x22, 0x20, 0x0a, 0x0c, 0x50, 0x6f, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x64, 0x6b, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x03, 0x69, 0x64, 0x6b, 0x32, 0x34, 0x0a, 0x0b, 0x4c, 0x6b, 0x61, 0x74, 0x53, 0x65, 0x72, 0x76,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x09, 0x5a, 0x07, 0x2f, 0x70,
...
var file_all_proto_depIdxs = []int32{
	0, // 0: LkatService.Ping:input_type -> PingRequest
	1, // 1: LkatService.Ping:output_type -> PongResponse
